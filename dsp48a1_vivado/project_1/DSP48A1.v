module dsp48a1
            (
                CLK,
                RSTA, RSTB, RSTC, RSTD, RSTM, RSTOPMODE, RSTP, RSTCARRYIN,
...
assign out_mux_opmode_4 = (opmode_reg[4] == 0) ? out_pre : b0;
...
assign x_mux = (opmode_reg[1 : 0] == 2'b11) ? {d[11 : 0], a1[17 : 0], b1[17 : 0]} : 
                (opmode_reg[1 : 0] == 2'b10) ? PCOUT : (opmode_reg[1 : 0] == 2'b01) ? {{12{1'b0}}, mul_reg} : 0;
