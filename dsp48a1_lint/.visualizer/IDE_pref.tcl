...
set perspective_DateTime   {2025-07-30T19:14:49}
set perspective_Directory  {D:/DIGITAL/projects/Spartan6_DSP48A1/dsp48a1_lint}
set perspective_USER       {Abdo Moamen}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###zinflownavigator,zinlintMsgView,zinmsgviewer,source,zincdcdutview,zinlintDesignMetricsView,zinlintMsgStatusHistoryView,zindetails,transcript,zinlintDesignInfoView,zinlintMsgDashboardView -hide -description none -label none
...
pref::set -type string -category Lint -name lintMessagesviewToolButtonFiltersTuple -value Check!-!Equals!-!mux_select_const!@!Severity!-!Equals!-!Warning!@!State!-!Equals!-!open!@!Status!-!Equals!-!pending!@!Status!-!Equals!-!uninspected!@!Status!-!Equals!-!bug -hide -description none -label none
